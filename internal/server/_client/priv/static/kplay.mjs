...
// build/dev/javascript/kplay/types.mjs
var Config = class extends CustomType {
  constructor(profile_name, brokers, topic) {
    super();
      ...
      return field2(
        ...
        (brokers) => {
          return field2(
            ...
            string3,
            (topic) => {
              return success(new Config(profile_name, brokers, topic));
            }
          );
        }
      );
...
// build/dev/javascript/kplay/update.mjs
...
function message_details_pane(model) {
    ...
    if ($1 instanceof Some) {
      ...
      _block = div(
        ...
        toList([
          ...
          pre(
            toList([class$("text-[#d5c4a1] text-base mb-8")]),
            toList([text2(msg.metadata)])
          ),
          p(
            toList([class$("text-[#fabd2f] text-lg mb-4")]),
            toList([text2("Value")])
  ...
  return div(
    ...
    toList([
      h2(
        toList([class$("text-[#fe8019] text-xl font-bold mb-4")]),
    ...
    toList([
      div(
        ...
        toList([
          p(
            toList([
              class$("text-nowrap w-48 text-[#fabd2f] overflow-clip")
            ]),
